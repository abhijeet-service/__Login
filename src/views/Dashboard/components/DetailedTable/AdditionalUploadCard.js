...
class AdditionalUploadCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabValue: 0,
    ...
    const sideList = (side) => (
      <div className="right-drawer">
        ...
        {Object.keys(this.props.modalDetails).length !== 0 ? (
          <>
            {this.props.modalDetails["ADD"] ? (
              <Table>
                <TableBody>
                  {Object.keys(modalDetails["ADD"]["document_details"]).map(
                    function(key) {
                      return (
                        <>
                          {modalDetails["ADD"]["document_details"][key] &&
                          typeof modalDetails["ADD"]["document_details"][
                            key
                          ] === "string" ? (
                            <TableRow>
      ...
      <>
        {Object.keys(this.props.modalDetails).length !== 0 ? (
          <>
            {this.props.modalDetails["ADD"] ? (
              <>
                {Object.keys(this.props.modalDetails["ADD"]).length !== 0 ? (
                  <>
                      ...
                      <ExpansionPanelSummary expandIcon={<ExpandMore />}>
                        <div className="flex-video-column">
                          <Typography>
                            <img
                              src={
                                this.props.modalDetails["ADD"]["document_link"]
                              }
                        ...
                        <div className="flex-video-row-column">
                          ...
                          <Typography>
                            {this.props.modalDetails["ADD"]["document_name"]}
                          </Typography>
                        </div>
                        <div className="flex-video-row-column">
                          <Typography>
                          ...
                          <Typography>
                            ...
                            {this.props.modalDetails["ADD"][
                              ...
                              <Typography className="successTypo">
                                {this.props.modalDetails["ADD"]["face_match"]}
                              </Typography>
                            ) : (
                    ...
                    <Dialog open={this.state.openApproveAlert}>
                      ...
                      <DialogActions>
                        <Button
                          ...
                          name="ADD"
                          id={this.props.modalDetails["ADD"]["document_name"]}
                          color="primary"
                        >
                          <b>Yes</b>
                        </Button>
...
export default AdditionalUploadCard;
