...
class AgentPOICard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabValue: 0,
    ...
    const sideList = (side) => (
      <div className="right-drawer">
        ...
        {Object.keys(this.props.modalDetails).length !== 0 ? (
          <>
            {this.props.modalDetails["POI"] ? (
              <Table>
                <TableBody>
                  {Object.keys(modalDetails["POI"]["document_details"]).map(
                    function(key) {
                      return (
                        <>
                          {modalDetails["POI"]["document_details"][key] &&
                          typeof modalDetails["POI"]["document_details"][
                            key
                          ] === "string" ? (
                            <TableRow>
      ...
      <>
        {Object.keys(this.props.modalDetails).length !== 0 ? (
          <>
            {this.props.modalDetails["POI"] ? (
              <>
                {Object.keys(this.props.modalDetails["POI"]).length !== 0 ? (
                  <>
                      ...
                      <ExpansionPanelSummary expandIcon={<ExpandMore />}>
                        <div className="flex-video-column">
                          <Typography>
                            <img
                              src={
                                this.props.modalDetails["POI"]["document_link"]
                              }
                        ...
                        <div className="flex-video-row-column">
                          ...
                          <Typography>
                            {this.props.modalDetails["POI"]["document_name"]}
                          </Typography>
                        </div>
                        <div className="flex-video-row-column">
                          <Typography>
                          ...
                          <Typography>
                            ...
                            {this.props.modalDetails["POI"][
                              ...
                              <Typography className="successTypo">
                                {this.props.modalDetails["POI"]["face_match"]}
                              </Typography>
                            ) : (
