...
class AadhaarDocument extends Component {
  ...
  onpoaADVerify = () => {
    ...
    this.props.onpoaADVerify(poa_ad_entity);
  };
  ...
  onSaveChangesClick = () => {
    let edit_details = {
      job_id: this.props.jobID,
      doc_name: this.props.poaADResponse["document_type"],
    };
    this.setState(
      {
        saveDisabled: true,
  ...
  render() {
    let poaADResponse = this.props.poaADResponse;
    ...
    const sideList = (side) => (
      <div className="right-drawer">
        ...
        {Object.keys(poaADResponse).length !== 0 ? (
          <>
            <Table>
              <TableBody>
                {Object.keys(poaADResponse["document_details"]).map(function(
                  key
                ) {
                  return (
                    <>
                      {//poaADResponse["document_details"][key] &&
                      typeof poaADResponse["document_details"][key] ===
                      "string" ? (
                        <TableRow>
                          ...
                          <TableCell className="formDetails">
                            {that.state.saveDisabled ? (
                              ...
                              <InputBase
                                ...
                                id={key}
                                name="POA"
                                value={poaADResponse["document_details"][key]}
                              />
                            )}
                          </TableCell>
                        </TableRow>
                                    ...
                                    {poaADResponse["document_details"][key][
                                      ...
                                      <TableRow>
                                        <TableCell
                                          className={
                                            Object.keys(
                                              poaADResponse["document_details"][
                                                key
                                              ]
                                            ).length -
                                              1 ===
    ...
    return (
      <Grid container spacing={2}>
        ...
        <Grid item lg={6} md={6} xl={6} xs={12}>
          <center>
            {Object.keys(this.props.poaADResponse).length === 0 ? (
              <>
                {this.props.errorADPOAResponse ? (
                  <div className="diy-right-side-div">
                    ...
                    <Typography className="diy-right-side-failed-message">
                      {!this.props.errorADPOAResponseMessage["error"] ? (
                        "Failed"
                      ) : (
                        <>{this.props.errorADPOAResponseMessage["error"]}</>
                      )}
              ...
              <div className="diy-right-side-content-div">
                <Grid container justify="center" alignItems="center">
                  <Grid item xs={12} lg={12} sm={12} xl={12}>
                    <div>
                      {this.props.poaADResponse["document_status"] ? (
                        <>
                          {this.props.poaADResponse["document_status"][
                            "validation"
                          ]["message"].length !== 0 ? (
                    ...
                    <Typography>
                      Document Image :
                      <a
                        href={this.props.poaADResponse["document_link"]}
                        target="_blank"
                        className="link"
                        rel="noopener noreferrer"
                        disableRipple
                      >
                        {this.props.poaADResponse["document_type"]}
                      </a>
                    </Typography>
                    <Link
                      href="#"
                    ...
                    <Typography
                      className={
                        (this.props.poaADResponse["status"] === 0 &&
                          "bad-confidence-score-typo") ||
                        (this.props.poaADResponse["status"] === 1 &&
                          "medium-confidence-score-typo") ||
                        (this.props.poaADResponse["status"] === 2 &&
                          "good-confidence-score-typo")
                      }
                    >
                      Extraction Score :{" "}
                      {this.props.poaADResponse["confidence_score"]}
                    </Typography>
                    <Drawer
                      anchor="right"
                      ...
                      <div className="sidelist-drawer-div">
                        ...
                        <div>
                          <Button
                            ...
                            id={this.props.poaADResponse["document_type"]}
                          >
                            <Edit />
                          </Button>
                        </div>
