...
class AdditionalDLDoc extends Component {
  constructor(props) {
    super(props);
    this.state = {
      files: [],
      disabledDLverify: true,
      right: false,
      doc_type: "DL Document",
      encodedFile: "",
      saveDisabled: true,
    };
  }
        ...
        <Grid item lg={6} md={6} xl={6} xs={12}>
          <center>
            ...
            <Button
              ...
              disabled={this.state.disabledDLverify}
            >
              Verify
            </Button>
          </center>
...
export default AdditionalDLDoc;
